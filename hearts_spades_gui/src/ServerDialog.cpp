...
ServerDialog::ServerDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticTextIP = new wxStaticText( this, wxID_ANY, wxT("IP Adress:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextIP->Wrap( -1 );
	bSizerServerSettings->Add( m_staticTextIP, 0, wxALL, 5 );
	
	m_textCtrlIP = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizerServerSettings->Add( m_textCtrlIP, 0, wxALL|wxEXPAND, 5 );
	
	m_staticTextPort = new wxStaticText( this, wxID_ANY, wxT("Port:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizerServerSettings->Add( m_submitBtn, 0, wxALL, 5 );
